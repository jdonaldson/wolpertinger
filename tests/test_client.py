...
@pytest.fixture
def owlbear_client():
    """Create OwlbearClient with mocked AWS client"""
...
class TestOwlbearClientInit:
    """Test OwlbearClient initialization"""
...
class TestExecuteQuery:
    ...
    def test_execute_query_basic(self, owlbear_client):
        """Test basic query execution"""
        client, mock_athena = owlbear_client
    ...
    def test_execute_query_no_wait(self, owlbear_client):
    ...
    def test_execute_query_with_workgroup(self, owlbear_client):
    ...
    def test_execute_query_failure(self, owlbear_client):
...
class TestWaitForCompletion:
    ...
    def test_wait_success(self, owlbear_client):
    ...
    def test_wait_failed_query(self, owlbear_client):
    ...
    def test_wait_cancelled_query(self, owlbear_client):
    ...
    @patch('time.sleep')
    def test_wait_timeout(self, mock_sleep, owlbear_client):
        """Test wait timeout"""
        client, mock_athena = owlbear_client
        mock_athena.get_query_execution.return_value = {
...
class TestGetResultsPolars:
    ...
    def test_get_results_basic(self, owlbear_client):
    ...
    def test_get_results_empty(self, owlbear_client):
        """Test empty results"""
        client, mock_athena = owlbear_client
    ...
    def test_get_results_with_nulls(self, owlbear_client):
    ...
    def test_get_results_pagination(self, owlbear_client):
    ...
    def test_get_results_error(self, owlbear_client):
...
class TestQueryInfo:
    ...
    def test_get_query_info(self, owlbear_client):
    ...
    def test_get_query_info_error(self, owlbear_client):
...
class TestCancelQuery:
    ...
    def test_cancel_query(self, owlbear_client):
    ...
    def test_cancel_query_error(self, owlbear_client):
...
class TestListWorkGroups:
    ...
    def test_list_work_groups(self, owlbear_client):
    ...
    def test_list_work_groups_error(self, owlbear_client):
